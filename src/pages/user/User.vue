<template>
  <div class="user">
    <div class="header">
      <router-link to="/Login" tag="div" class="add" v-if="!isExcest"><div class="user_img"><span class="iconfont ico_user">&#xe656;</span></div><div class="user_name">登陆/注册</div></router-link>
      <div class="add" v-if="isExcest"><div class="user_img"><span class="iconfont ico_user">&#xe656;</span></div><div class="user_name"><i>大鸟</i><br><i>123456</i></div></div>
    </div>
    <div class="wraper" ref="wraper">
      <div>
        <div class="my_order">
          <div class="order">我的订单</div><div class="all_order">全部订单 <span class="iconfont arrow">&#xe62d;</span></div>
        </div>
...
.user
  ...
  .header
    height: 1.6rem
    background: url("https://m.mi.com/static/img/bg.63c8e19851.png") center 0 rgb(243, 125, 15)
  ...
  .wraper
    ...
    .my_order
      ...
      border-bottom: .02rem solid rgba(0, 0, 0, .15)
      .order
        font-size: .28rem
      .all_order
        font-size: .24rem
    ...
    .order_state
      ...
      padding: .35rem .8rem
      background: #fff
      .obligation, .receiving, .aftersale
        text-align: center
        .ic
          font-size: .5rem
          color: #a7a7a7
        .spa
          ...
          color: #5c5c5c
          display: block
    .vip_center, .service_center, .f_center
      background: #fff
      padding: 0 0 0 .3rem
      margin-top: $topMargin
      .center, .discounts, .se_center, .f_aisle
        height: 1rem
        display: flex
        align-items: center
        img

...
<div class="header">
  ...
  <router-link tag="div" to="/Search" class="search"><i class="iconfont">&#xe603;</i>搜索商品名称</router-link>
  <router-link tag="div" to="/Home/User" class="user"><i class="iconfont userico">&#xe67b;</i></router-link>
</div>
</template>
